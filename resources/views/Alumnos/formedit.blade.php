<div class="container-fluid">
                                <div class="row">
                                    <div class="form-group col">
                                        ...
                                        <input type="text" name="NIE" value="{{ $alumnos->NIE }}" class="form-control form-control-sm col-sm-4" id="NIE" placeholder="Ej: AA-0001">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col">
                                ...
                                <div class="row">
                                    <div class="form-group col">
                                        ...
                                        <input type="text" name="telefonoalum" value="{{ $alumnos->telefonoalum }}" class="form-control form-control-sm col-sm-4" id="telefonoalum" placeholder="Telefono">
                                    </div>
                                    <div class="row">
                                    <div class="form-group col">
                                        <label class="col-form-label col-form-label-sm" for="sexo">Sexo</label>
                                        <input type="text" name="sexo" value="{{ $alumnos->sexo }}" class="form-control form-control-sm col-sm-4" id="sexo" placeholder="F/M">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col">
                                        <label class="col-form-label col-form-label-sm" for="fNacimiento">Fecha de Nacimiento</label>
                                        <input type="date" name="fNacimiento" value="{{ $alumnos->fNacimiento }}" class="form-control form-control-sm col-sm-4" id="fNacimiento" placeholder="Nacimiento">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col">
                                        ...
                                        <input type="date" name="fIngreso" value="{{ $alumnos->fIngreso }}" class="form-control form-control-sm col-sm-4" id="fIngreso" placeholder="Ingreso">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                    <div class="form-group col">
                                        ...
                                        <input type="text" name="direccion" value="{{ $alumnos->direccion }}" class="form-control form-control-sm col-sm-4" id="direccion" placeholder="direccion">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                    <div class="form-group col">
                                        ...
                                        <input type="text" name="responsable" value="{{ $alumnos->responsable }}" class="form-control form-control-sm col-sm-4" id="responsable" placeholder="responsable">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                    <div class="form-group col">
                                        ...
                                        <input type="text" name="curso" value="{{ $alumnos->curso }}" class="form-control form-control-sm col-sm-4" id="curso" placeholder="curso">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                    <div class="form-group col">
                                        ...
                                        <input type="text" name="estado" value="{{ $alumnos->estado }}" class="form-control form-control-sm col-sm-4" id="estado" placeholder="estado">
                                    </div>
                                </div>
